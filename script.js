...
function checkemail(email)
{
    if(email.length>8 && email.includes('@gmail')){
        ...
        document.getElementById('email_error').innerText='email must be 8 letters long and must include @gmail'
    }
}
...
function checkpassword(password)
{
    if(password.length>7 && password.includes('.')){
        ...
        document.getElementById('password_error').innerText='password must be 8 letters long and must include .'
    }
}
